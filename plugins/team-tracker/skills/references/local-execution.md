...
- **În ChatGPT/Codex, poți folosi și `@Browser`, browserul integrat în IDE.** Este o
  opțiune pentru testare, alături de celelalte instrumente de browser disponibile în
...
- Dacă `@Browser` nu este disponibil, folosește alt browser accesibil în sesiune. Dacă
...
- Include regula de execuție locală și opțiunea `@Browser` în prompturile de implementare sau
