...
26. Any selected task that changes code includes final diff review through `../references/code-review-before-merge.md` after verification. Review in the current session. Fix confirmed findings and rerun affected checks before merge. Merge when CI is green; do not run or wait for Bugbot.
